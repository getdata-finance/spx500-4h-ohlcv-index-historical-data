...
> **Sample on GitHub** · `SPX500_4h.csv` (242 rows, `2026-07-07` -> `2026-09-02`, 15.43 KB). **Full archive on [getdata.finance](https://getdata.finance/datasets/spx500)** — **27,341** `4h` rows (full `1m`: 5,964,774), **11 timeframes**, `2008-08-18` -> `2026-09-02`.
...
| 4h rows | 242 | **27,341** |
| Size | 15.43 KB | full ZIP on [getdata.finance](https://getdata.finance/datasets/spx500) |
